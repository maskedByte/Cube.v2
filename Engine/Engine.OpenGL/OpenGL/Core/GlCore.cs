...
partial class Gl
{
    internal static partial class NativeMethods
    {
        ...
        internal static extern void BindBuffersRange(BufferTarget target, UInt32 first, Int32 count, UInt32[] buffers, IntPtr[] offsets, IntPtr[] sizes);
        ...
        internal static extern void BindImageTexture(UInt32 unit, UInt32 texture, Int32 level, Boolean layered, Int32 layer, BufferAccess access, PixelInternalFormat format);
        ...
        internal static extern void BlendEquationSeparatei(UInt32 buf, BlendEquationMode modeRgb, BlendEquationMode modeAlpha);
        ...
        internal static extern void BlendFuncSeparatei(UInt32 buf, BlendingFactorSrc srcRgb, BlendingFactorDest dstRgb, BlendingFactorSrc srcAlpha, BlendingFactorDest dstAlpha);
        [DllImport(Library, EntryPoint = "glBlitFramebuffer", ExactSpelling = true)]
        internal static extern void BlitFramebuffer(Int32 srcX0, Int32 srcY0, Int32 srcX1, Int32 srcY1, Int32 dstX0, Int32 dstY0, Int32 dstX1, Int32 dstY1, ClearBufferMask mask, BlitFramebufferFilter filter);
        [DllImport(Library, EntryPoint = "glBlitNamedFramebuffer", ExactSpelling = true)]
        internal static extern void BlitNamedFramebuffer(UInt32 readFramebuffer, UInt32 drawFramebuffer, Int32 srcX0, Int32 srcY0, Int32 srcX1, Int32 srcY1, Int32 dstX0, Int32 dstY0, Int32 dstX1, Int32 dstY1, ClearBufferMask mask, BlitFramebufferFilter filter);
        ...
        internal static extern FramebufferErrorCode CheckNamedFramebufferStatus(UInt32 framebuffer, FramebufferTarget target);
        ...
        internal static extern void ClearNamedFramebufferiv(UInt32 framebuffer, ClearBuffer buffer, Int32 drawbuffer, Int32[] value);
        [DllImport(Library, EntryPoint = "glClearNamedFramebufferuiv", ExactSpelling = true)]
        internal static extern void ClearNamedFramebufferuiv(UInt32 framebuffer, ClearBuffer buffer, Int32 drawbuffer, UInt32[] value);
        [DllImport(Library, EntryPoint = "glClearNamedFramebufferfv", ExactSpelling = true)]
        internal static extern void ClearNamedFramebufferfv(UInt32 framebuffer, ClearBuffer buffer, Int32 drawbuffer, Single[] value);
        [DllImport(Library, EntryPoint = "glClearNamedFramebufferfi", ExactSpelling = true)]
        internal static extern void ClearNamedFramebufferfi(UInt32 framebuffer, ClearBuffer buffer, Int32 drawbuffer, Single depth, Int32 stencil);
        [DllImport(Library, EntryPoint = "glClearBufferData", ExactSpelling = true)]
        internal static extern void ClearBufferData(BufferTarget target, SizedInternalFormat internalFormat, PixelInternalFormat format, PixelType type, IntPtr data);
        [DllImport(Library, EntryPoint = "glClearNamedBufferData", ExactSpelling = true)]
        internal static extern void ClearNamedBufferData(UInt32 buffer, SizedInternalFormat internalFormat, PixelInternalFormat format, PixelType type, IntPtr data);
        [DllImport(Library, EntryPoint = "glClearBufferSubData", ExactSpelling = true)]
        internal static extern void ClearBufferSubData(BufferTarget target, SizedInternalFormat internalFormat, IntPtr offset, IntPtr size, PixelInternalFormat format, PixelType type, IntPtr data);
        [DllImport(Library, EntryPoint = "glClearNamedBufferSubData", ExactSpelling = true)]
        internal static extern void ClearNamedBufferSubData(UInt32 buffer, SizedInternalFormat internalFormat, IntPtr offset, Int32 size, PixelInternalFormat format, PixelType type, IntPtr data);
        ...
        internal static extern void ClearTexImage(UInt32 texture, Int32 level, PixelInternalFormat format, PixelType type, IntPtr data);
        [DllImport(Library, EntryPoint = "glClearTexSubImage", ExactSpelling = true)]
        internal static extern void ClearTexSubImage(UInt32 texture, Int32 level, Int32 xoffset, Int32 yoffset, Int32 zoffset, Int32 width, Int32 height, Int32 depth, PixelInternalFormat format, PixelType type, IntPtr data);
        ...
        internal static extern void CompressedTexImage1D(TextureTarget target, Int32 level, PixelInternalFormat internalFormat, Int32 width, Int32 border, Int32 imageSize, IntPtr data);
        [DllImport(Library, EntryPoint = "glCompressedTexImage2D", ExactSpelling = true)]
        internal static extern void CompressedTexImage2D(TextureTarget target, Int32 level, PixelInternalFormat internalFormat, Int32 width, Int32 height, Int32 border, Int32 imageSize, IntPtr data);
        [DllImport(Library, EntryPoint = "glCompressedTexImage3D", ExactSpelling = true)]
        internal static extern void CompressedTexImage3D(TextureTarget target, Int32 level, PixelInternalFormat internalFormat, Int32 width, Int32 height, Int32 depth, Int32 border, Int32 imageSize, IntPtr data);
        [DllImport(Library, EntryPoint = "glCompressedTexSubImage1D", ExactSpelling = true)]
        internal static extern void CompressedTexSubImage1D(TextureTarget target, Int32 level, Int32 xoffset, Int32 width, PixelFormat format, Int32 imageSize, IntPtr data);
        [DllImport(Library, EntryPoint = "glCompressedTextureSubImage1D", ExactSpelling = true)]
        internal static extern void CompressedTextureSubImage1D(UInt32 texture, Int32 level, Int32 xoffset, Int32 width, PixelInternalFormat format, Int32 imageSize, IntPtr data);
        [DllImport(Library, EntryPoint = "glCompressedTexSubImage2D", ExactSpelling = true)]
        internal static extern void CompressedTexSubImage2D(TextureTarget target, Int32 level, Int32 xoffset, Int32 yoffset, Int32 width, Int32 height, PixelFormat format, Int32 imageSize, IntPtr data);
        [DllImport(Library, EntryPoint = "glCompressedTextureSubImage2D", ExactSpelling = true)]
        internal static extern void CompressedTextureSubImage2D(UInt32 texture, Int32 level, Int32 xoffset, Int32 yoffset, Int32 width, Int32 height, PixelInternalFormat format, Int32 imageSize, IntPtr data);
        [DllImport(Library, EntryPoint = "glCompressedTexSubImage3D", ExactSpelling = true)]
        internal static extern void CompressedTexSubImage3D(TextureTarget target, Int32 level, Int32 xoffset, Int32 yoffset, Int32 zoffset, Int32 width, Int32 height, Int32 depth, PixelFormat format, Int32 imageSize, IntPtr data);
        [DllImport(Library, EntryPoint = "glCompressedTextureSubImage3D", ExactSpelling = true)]
        internal static extern void CompressedTextureSubImage3D(UInt32 texture, Int32 level, Int32 xoffset, Int32 yoffset, Int32 zoffset, Int32 width, Int32 height, Int32 depth, PixelInternalFormat format, Int32 imageSize, IntPtr data);
        ...
        internal static extern void CopyImageSubData(UInt32 srcName, BufferTarget srcTarget, Int32 srcLevel, Int32 srcX, Int32 srcY, Int32 srcZ, UInt32 dstName, BufferTarget dstTarget, Int32 dstLevel, Int32 dstX, Int32 dstY, Int32 dstZ, Int32 srcWidth, Int32 srcHeight, Int32 srcDepth);
        [DllImport(Library, EntryPoint = "glCopyTexImage1D", ExactSpelling = true)]
        internal static extern void CopyTexImage1D(TextureTarget target, Int32 level, PixelInternalFormat internalFormat, Int32 x, Int32 y, Int32 width, Int32 border);
        [DllImport(Library, EntryPoint = "glCopyTexImage2D", ExactSpelling = true)]
        internal static extern void CopyTexImage2D(TextureTarget target, Int32 level, PixelInternalFormat internalFormat, Int32 x, Int32 y, Int32 width, Int32 height, Int32 border);
        [DllImport(Library, EntryPoint = "glCopyTexSubImage1D", ExactSpelling = true)]
        internal static extern void CopyTexSubImage1D(TextureTarget target, Int32 level, Int32 xoffset, Int32 x, Int32 y, Int32 width);
        ...
        internal static extern void CopyTexSubImage2D(TextureTarget target, Int32 level, Int32 xoffset, Int32 yoffset, Int32 x, Int32 y, Int32 width, Int32 height);
        ...
        internal static extern void CopyTexSubImage3D(TextureTarget target, Int32 level, Int32 xoffset, Int32 yoffset, Int32 zoffset, Int32 x, Int32 y, Int32 width, Int32 height);
        ...
        internal static extern void DrawArraysInstancedBaseInstance(BeginMode mode, Int32 first, Int32 count, Int32 primcount, UInt32 baseinstance);
        ...
        internal static extern void DrawElementsBaseVertex(BeginMode mode, Int32 count, DrawElementsType type, IntPtr indices, Int32 basevertex);
        ...
        internal static extern void DrawElementsInstanced(BeginMode mode, Int32 count, DrawElementsType type, IntPtr indices, Int32 primcount);
        [DllImport(Library, EntryPoint = "glDrawElementsInstancedBaseInstance", ExactSpelling = true)]
        internal static extern void DrawElementsInstancedBaseInstance(BeginMode mode, Int32 count, DrawElementsType type, IntPtr indices, Int32 primcount, UInt32 baseinstance);
        [DllImport(Library, EntryPoint = "glDrawElementsInstancedBaseVertex", ExactSpelling = true)]
        internal static extern void DrawElementsInstancedBaseVertex(BeginMode mode, Int32 count, DrawElementsType type, IntPtr indices, Int32 primcount, Int32 basevertex);
        [DllImport(Library, EntryPoint = "glDrawElementsInstancedBaseVertexBaseInstance", ExactSpelling = true)]
        internal static extern void DrawElementsInstancedBaseVertexBaseInstance(BeginMode mode, Int32 count, DrawElementsType type, IntPtr indices, Int32 primcount, Int32 basevertex, UInt32 baseinstance);
        [DllImport(Library, EntryPoint = "glDrawRangeElements", ExactSpelling = true)]
        internal static extern void DrawRangeElements(BeginMode mode, UInt32 start, UInt32 end, Int32 count, DrawElementsType type, IntPtr indices);
        [DllImport(Library, EntryPoint = "glDrawRangeElementsBaseVertex", ExactSpelling = true)]
        internal static extern void DrawRangeElementsBaseVertex(BeginMode mode, UInt32 start, UInt32 end, Int32 count, DrawElementsType type, IntPtr indices, Int32 basevertex);
        ...
        internal static extern void DrawTransformFeedbackStreamInstanced(BeginMode mode, UInt32 id, UInt32 stream, Int32 primcount);
        ...
        internal static extern void FramebufferParameteri(FramebufferTarget target, FramebufferPName pname, Int32 param);
        ...
        internal static extern void FramebufferRenderbuffer(FramebufferTarget target, FramebufferAttachment attachment, RenderbufferTarget renderbuffertarget, UInt32 renderbuffer);
        [DllImport(Library, EntryPoint = "glNamedFramebufferRenderbuffer", ExactSpelling = true)]
        internal static extern void NamedFramebufferRenderbuffer(UInt32 framebuffer, FramebufferAttachment attachment, RenderbufferTarget renderbuffertarget, UInt32 renderbuffer);
        [DllImport(Library, EntryPoint = "glFramebufferTexture", ExactSpelling = true)]
        internal static extern void FramebufferTexture(FramebufferTarget target, FramebufferAttachment attachment, UInt32 texture, Int32 level);
        [DllImport(Library, EntryPoint = "glFramebufferTexture1D", ExactSpelling = true)]
        internal static extern void FramebufferTexture1D(FramebufferTarget target, FramebufferAttachment attachment, TextureTarget textarget, UInt32 texture, Int32 level);
        [DllImport(Library, EntryPoint = "glFramebufferTexture2D", ExactSpelling = true)]
        internal static extern void FramebufferTexture2D(FramebufferTarget target, FramebufferAttachment attachment, TextureTarget textarget, UInt32 texture, Int32 level);
        [DllImport(Library, EntryPoint = "glFramebufferTexture3D", ExactSpelling = true)]
        internal static extern void FramebufferTexture3D(FramebufferTarget target, FramebufferAttachment attachment, TextureTarget textarget, UInt32 texture, Int32 level, Int32 layer);
        [DllImport(Library, EntryPoint = "glNamedFramebufferTexture", ExactSpelling = true)]
        internal static extern void NamedFramebufferTexture(UInt32 framebuffer, FramebufferAttachment attachment, UInt32 texture, Int32 level);
        [DllImport(Library, EntryPoint = "glFramebufferTextureLayer", ExactSpelling = true)]
        internal static extern void FramebufferTextureLayer(FramebufferTarget target, FramebufferAttachment attachment, UInt32 texture, Int32 level, Int32 layer);
        [DllImport(Library, EntryPoint = "glNamedFramebufferTextureLayer", ExactSpelling = true)]
        internal static extern void NamedFramebufferTextureLayer(UInt32 framebuffer, FramebufferAttachment attachment, UInt32 texture, Int32 level, Int32 layer);
        ...
        internal static extern void GetActiveAtomicCounterBufferiv(UInt32 program, UInt32 bufferIndex, AtomicCounterParameterName pname, [Out] Int32[] @params);
        [DllImport(Library, EntryPoint = "glGetActiveAttrib", ExactSpelling = true)]
        internal static extern void GetActiveAttrib(UInt32 program, UInt32 index, Int32 bufSize, [Out] Int32[] length, [Out] Int32[] size, [Out] ActiveAttribType[] type, [Out] System.Text.StringBuilder name);
        [DllImport(Library, EntryPoint = "glGetActiveSubroutineName", ExactSpelling = true)]
        internal static extern void GetActiveSubroutineName(UInt32 program, ShaderType shadertype, UInt32 index, Int32 bufsize, [Out] Int32[] length, [Out] System.Text.StringBuilder name);
        [DllImport(Library, EntryPoint = "glGetActiveSubroutineUniformiv", ExactSpelling = true)]
        internal static extern void GetActiveSubroutineUniformiv(UInt32 program, ShaderType shadertype, UInt32 index, SubroutineParameterName pname, [Out] Int32[] values);
        [DllImport(Library, EntryPoint = "glGetActiveSubroutineUniformName", ExactSpelling = true)]
        internal static extern void GetActiveSubroutineUniformName(UInt32 program, ShaderType shadertype, UInt32 index, Int32 bufsize, [Out] Int32[] length, [Out] System.Text.StringBuilder name);
        [DllImport(Library, EntryPoint = "glGetActiveUniform", ExactSpelling = true)]
        internal static extern void GetActiveUniform(UInt32 program, UInt32 index, Int32 bufSize, [Out] Int32[] length, [Out] Int32[] size, [Out] ActiveUniformType[] type, [Out] System.Text.StringBuilder name);
        [DllImport(Library, EntryPoint = "glGetActiveUniformBlockiv", ExactSpelling = true)]
        internal static extern void GetActiveUniformBlockiv(UInt32 program, UInt32 uniformBlockIndex, ActiveUniformBlockParameter pname, [Out] Int32[] @params);
        [DllImport(Library, EntryPoint = "glGetActiveUniformBlockName", ExactSpelling = true)]
        internal static extern void GetActiveUniformBlockName(UInt32 program, UInt32 uniformBlockIndex, Int32 bufSize, [Out] Int32[] length, [Out] System.Text.StringBuilder uniformBlockName);
        [DllImport(Library, EntryPoint = "glGetActiveUniformName", ExactSpelling = true)]
        internal static extern void GetActiveUniformName(UInt32 program, UInt32 uniformIndex, Int32 bufSize, [Out] Int32[] length, [Out] System.Text.StringBuilder uniformName);
        [DllImport(Library, EntryPoint = "glGetActiveUniformsiv", ExactSpelling = true)]
        internal static extern void GetActiveUniformsiv(UInt32 program, Int32 uniformCount, [Out] UInt32[] uniformIndices, ActiveUniformType pname, [Out] Int32[] @params);
        [DllImport(Library, EntryPoint = "glGetAttachedShaders", ExactSpelling = true)]
        internal static extern void GetAttachedShaders(UInt32 program, Int32 maxCount, [Out] Int32[] count, [Out] UInt32[] shaders);
        ...
        internal static extern void GetBufferParameteriv(BufferTarget target, BufferParameterName value, [Out] Int32[] data);
        [DllImport(Library, EntryPoint = "glGetBufferParameteri64v", ExactSpelling = true)]
        internal static extern void GetBufferParameteri64v(BufferTarget target, BufferParameterName value, [Out] Int64[] data);
        [DllImport(Library, EntryPoint = "glGetNamedBufferParameteriv", ExactSpelling = true)]
        internal static extern void GetNamedBufferParameteriv(UInt32 buffer, BufferParameterName pname, [Out] Int32[] @params);
        [DllImport(Library, EntryPoint = "glGetNamedBufferParameteri64v", ExactSpelling = true)]
        internal static extern void GetNamedBufferParameteri64v(UInt32 buffer, BufferParameterName pname, [Out] Int64[] @params);
        ...
        internal static extern void GetnCompressedTexImage(TextureTarget target, Int32 level, Int32 bufSize, [Out] IntPtr pixels);
        [DllImport(Library, EntryPoint = "glGetCompressedTextureImage", ExactSpelling = true)]
        internal static extern void GetCompressedTextureImage(UInt32 texture, Int32 level, Int32 bufSize, [Out] IntPtr pixels);
        [DllImport(Library, EntryPoint = "glGetCompressedTextureSubImage", ExactSpelling = true)]
        internal static extern void GetCompressedTextureSubImage(UInt32 texture, Int32 level, Int32 xoffset, Int32 yoffset, Int32 zoffset, Int32 width, Int32 height, Int32 depth, Int32 bufSize, [Out] IntPtr pixels);
        ...
        internal static extern void GetFramebufferAttachmentParameteriv(FramebufferTarget target, FramebufferAttachment attachment, FramebufferParameterName pname, [Out] Int32[] @params);
        [DllImport(Library, EntryPoint = "glGetNamedFramebufferAttachmentParameteriv", ExactSpelling = true)]
        internal static extern void GetNamedFramebufferAttachmentParameteriv(UInt32 framebuffer, FramebufferAttachment attachment, FramebufferParameterName pname, [Out] Int32[] @params);
        [DllImport(Library, EntryPoint = "glGetFramebufferParameteriv", ExactSpelling = true)]
        internal static extern void GetFramebufferParameteriv(FramebufferTarget target, FramebufferPName pname, [Out] Int32[] @params);
        [DllImport(Library, EntryPoint = "glGetNamedFramebufferParameteriv", ExactSpelling = true)]
        internal static extern void GetNamedFramebufferParameteriv(UInt32 framebuffer, FramebufferPName pname, [Out] Int32[] param);
        ...
        internal static extern void GetInternalformativ(TextureTarget target, PixelInternalFormat internalFormat, GetPName pname, Int32 bufSize, [Out] Int32[] @params);
        [DllImport(Library, EntryPoint = "glGetInternalformati64v", ExactSpelling = true)]
        internal static extern void GetInternalformati64v(TextureTarget target, PixelInternalFormat internalFormat, GetPName pname, Int32 bufSize, [Out] Int64[] @params);
        ...
        internal static extern void GetObjectLabel(ObjectLabel identifier, UInt32 name, Int32 bufSize, [Out] Int32[] length, [Out] System.Text.StringBuilder label);
        [DllImport(Library, EntryPoint = "glGetObjectPtrLabel", ExactSpelling = true)]
        internal static extern void GetObjectPtrLabel([Out] IntPtr ptr, Int32 bufSize, [Out] Int32[] length, [Out] System.Text.StringBuilder label);
        ...
        internal static extern void GetProgramBinary(UInt32 program, Int32 bufsize, [Out] Int32[] length, [Out] Int32[] binaryFormat, [Out] IntPtr binary);
        [DllImport(Library, EntryPoint = "glGetProgramInfoLog", ExactSpelling = true)]
        internal static extern void GetProgramInfoLog(UInt32 program, Int32 maxLength, [Out] Int32[] length, [Out] System.Text.StringBuilder infoLog);
        [DllImport(Library, EntryPoint = "glGetProgramInterfaceiv", ExactSpelling = true)]
        internal static extern void GetProgramInterfaceiv(UInt32 program, ProgramInterface programInterface, ProgramInterfaceParameterName pname, [Out] Int32[] @params);
        ...
        internal static extern void GetProgramPipelineInfoLog(UInt32 pipeline, Int32 bufSize, [Out] Int32[] length, [Out] System.Text.StringBuilder infoLog);
        [DllImport(Library, EntryPoint = "glGetProgramResourceiv", ExactSpelling = true)]
        internal static extern void GetProgramResourceiv(UInt32 program, ProgramInterface programInterface, UInt32 index, Int32 propCount, [Out] ProgramResourceParameterName[] props, Int32 bufSize, [Out] Int32[] length, [Out] Int32[] @params);
        [DllImport(Library, EntryPoint = "glGetProgramResourceIndex", ExactSpelling = true)]
        internal static extern UInt32 GetProgramResourceIndex(UInt32 program, ProgramInterface programInterface, String name);
        [DllImport(Library, EntryPoint = "glGetProgramResourceLocation", ExactSpelling = true)]
        internal static extern Int32 GetProgramResourceLocation(UInt32 program, ProgramInterface programInterface, String name);
        [DllImport(Library, EntryPoint = "glGetProgramResourceLocationIndex", ExactSpelling = true)]
        internal static extern Int32 GetProgramResourceLocationIndex(UInt32 program, ProgramInterface programInterface, String name);
        [DllImport(Library, EntryPoint = "glGetProgramResourceName", ExactSpelling = true)]
        internal static extern void GetProgramResourceName(UInt32 program, ProgramInterface programInterface, UInt32 index, Int32 bufSize, [Out] Int32[] length, [Out] System.Text.StringBuilder name);
        [DllImport(Library, EntryPoint = "glGetProgramStageiv", ExactSpelling = true)]
        internal static extern void GetProgramStageiv(UInt32 program, ShaderType shadertype, ProgramStageParameterName pname, [Out] Int32[] values);
        [DllImport(Library, EntryPoint = "glGetQueryIndexediv", ExactSpelling = true)]
        internal static extern void GetQueryIndexediv(QueryTarget target, UInt32 index, GetQueryParam pname, [Out] Int32[] @params);
        ...
        internal static extern void GetRenderbufferParameteriv(RenderbufferTarget target, RenderbufferParameterName pname, [Out] Int32[] @params);
        [DllImport(Library, EntryPoint = "glGetNamedRenderbufferParameteriv", ExactSpelling = true)]
        internal static extern void GetNamedRenderbufferParameteriv(UInt32 renderbuffer, RenderbufferParameterName pname, [Out] Int32[] @params);
        [DllImport(Library, EntryPoint = "glGetSamplerParameterfv", ExactSpelling = true)]
        internal static extern void GetSamplerParameterfv(UInt32 sampler, TextureParameterName pname, [Out] Single[] @params);
        [DllImport(Library, EntryPoint = "glGetSamplerParameteriv", ExactSpelling = true)]
        internal static extern void GetSamplerParameteriv(UInt32 sampler, TextureParameterName pname, [Out] Int32[] @params);
        [DllImport(Library, EntryPoint = "glGetSamplerParameterIiv", ExactSpelling = true)]
        internal static extern void GetSamplerParameterIiv(UInt32 sampler, TextureParameterName pname, [Out] Int32[] @params);
        [DllImport(Library, EntryPoint = "glGetSamplerParameterIuiv", ExactSpelling = true)]
        internal static extern void GetSamplerParameterIuiv(UInt32 sampler, TextureParameterName pname, [Out] UInt32[] @params);
        ...
        internal static extern void GetShaderInfoLog(UInt32 shader, Int32 maxLength, [Out] Int32[] length, [Out] System.Text.StringBuilder infoLog);
        [DllImport(Library, EntryPoint = "glGetShaderPrecisionFormat", ExactSpelling = true)]
        internal static extern void GetShaderPrecisionFormat(ShaderType shaderType, Int32 precisionType, [Out] Int32[] range, [Out] Int32[] precision);
        [DllImport(Library, EntryPoint = "glGetShaderSource", ExactSpelling = true)]
        internal static extern void GetShaderSource(UInt32 shader, Int32 bufSize, [Out] Int32[] length, [Out] System.Text.StringBuilder source);
        ...
        internal static extern void GetSynciv(IntPtr sync, ArbSync pname, Int32 bufSize, [Out] Int32[] length, [Out] Int32[] values);
        [DllImport(Library, EntryPoint = "glGetTexImage", ExactSpelling = true)]
        internal static extern void GetTexImage(TextureTarget target, Int32 level, PixelFormat format, PixelType type, [Out] IntPtr pixels);
        [DllImport(Library, EntryPoint = "glGetnTexImage", ExactSpelling = true)]
        internal static extern void GetnTexImage(TextureTarget target, Int32 level, PixelFormat format, PixelType type, Int32 bufSize, [Out] IntPtr pixels);
        [DllImport(Library, EntryPoint = "glGetTextureImage", ExactSpelling = true)]
        internal static extern void GetTextureImage(UInt32 texture, Int32 level, PixelFormat format, PixelType type, Int32 bufSize, [Out] IntPtr pixels);
        [DllImport(Library, EntryPoint = "glGetTexLevelParameterfv", ExactSpelling = true)]
        internal static extern void GetTexLevelParameterfv(GetPName target, Int32 level, GetTextureLevelParameter pname, [Out] Single[] @params);
        [DllImport(Library, EntryPoint = "glGetTexLevelParameteriv", ExactSpelling = true)]
        internal static extern void GetTexLevelParameteriv(GetPName target, Int32 level, GetTextureLevelParameter pname, [Out] Int32[] @params);
        [DllImport(Library, EntryPoint = "glGetTextureLevelParameterfv", ExactSpelling = true)]
        internal static extern void GetTextureLevelParameterfv(UInt32 texture, Int32 level, GetTextureLevelParameter pname, [Out] Single[] @params);
        [DllImport(Library, EntryPoint = "glGetTextureLevelParameteriv", ExactSpelling = true)]
        internal static extern void GetTextureLevelParameteriv(UInt32 texture, Int32 level, GetTextureLevelParameter pname, [Out] Int32[] @params);
        [DllImport(Library, EntryPoint = "glGetTexParameterfv", ExactSpelling = true)]
        internal static extern void GetTexParameterfv(TextureTarget target, GetTextureParameter pname, [Out] Single[] @params);
        [DllImport(Library, EntryPoint = "glGetTexParameteriv", ExactSpelling = true)]
        internal static extern void GetTexParameteriv(TextureTarget target, GetTextureParameter pname, [Out] Int32[] @params);
        [DllImport(Library, EntryPoint = "glGetTexParameterIiv", ExactSpelling = true)]
        internal static extern void GetTexParameterIiv(TextureTarget target, GetTextureParameter pname, [Out] Int32[] @params);
        [DllImport(Library, EntryPoint = "glGetTexParameterIuiv", ExactSpelling = true)]
        internal static extern void GetTexParameterIuiv(TextureTarget target, GetTextureParameter pname, [Out] UInt32[] @params);
        [DllImport(Library, EntryPoint = "glGetTextureParameterfv", ExactSpelling = true)]
        internal static extern void GetTextureParameterfv(UInt32 texture, GetTextureParameter pname, [Out] Single[] @params);
        [DllImport(Library, EntryPoint = "glGetTextureParameteriv", ExactSpelling = true)]
        internal static extern void GetTextureParameteriv(UInt32 texture, GetTextureParameter pname, [Out] Int32[] @params);
        [DllImport(Library, EntryPoint = "glGetTextureParameterIiv", ExactSpelling = true)]
        internal static extern void GetTextureParameterIiv(UInt32 texture, GetTextureParameter pname, [Out] Int32[] @params);
        [DllImport(Library, EntryPoint = "glGetTextureParameterIuiv", ExactSpelling = true)]
        internal static extern void GetTextureParameterIuiv(UInt32 texture, GetTextureParameter pname, [Out] UInt32[] @params);
        [DllImport(Library, EntryPoint = "glGetTextureSubImage", ExactSpelling = true)]
        internal static extern void GetTextureSubImage(UInt32 texture, Int32 level, Int32 xoffset, Int32 yoffset, Int32 zoffset, Int32 width, Int32 height, Int32 depth, PixelFormat format, PixelType type, Int32 bufSize, [Out] IntPtr pixels);
        [DllImport(Library, EntryPoint = "glGetTransformFeedbackiv", ExactSpelling = true)]
        internal static extern void GetTransformFeedbackiv(UInt32 xfb, TransformFeedbackParameterName pname, [Out] Int32[] param);
        [DllImport(Library, EntryPoint = "glGetTransformFeedbacki_v", ExactSpelling = true)]
        internal static extern void GetTransformFeedbacki_v(UInt32 xfb, TransformFeedbackParameterName pname, UInt32 index, [Out] Int32[] param);
        [DllImport(Library, EntryPoint = "glGetTransformFeedbacki64_v", ExactSpelling = true)]
        internal static extern void GetTransformFeedbacki64_v(UInt32 xfb, TransformFeedbackParameterName pname, UInt32 index, [Out] Int64[] param);
        [DllImport(Library, EntryPoint = "glGetTransformFeedbackVarying", ExactSpelling = true)]
        internal static extern void GetTransformFeedbackVarying(UInt32 program, UInt32 index, Int32 bufSize, [Out] Int32[] length, [Out] Int32[] size, [Out] ActiveAttribType[] type, [Out] System.Text.StringBuilder name);
        ...
        internal static extern void GetnUniformfv(UInt32 program, Int32 location, Int32 bufSize, [Out] Single[] @params);
        ...
        internal static extern void GetnUniformuiv(UInt32 program, Int32 location, Int32 bufSize, [Out] UInt32[] @params);
        [DllImport(Library, EntryPoint = "glGetnUniformdv", ExactSpelling = true)]
        internal static extern void GetnUniformdv(UInt32 program, Int32 location, Int32 bufSize, [Out] Double[] @params);
        ...
        internal static extern void GetUniformIndices(UInt32 program, Int32 uniformCount, String uniformNames, [Out] UInt32[] uniformIndices);
        ...
        internal static extern void GetUniformSubroutineuiv(ShaderType shadertype, Int32 location, [Out] UInt32[] values);
        [DllImport(Library, EntryPoint = "glGetVertexArrayIndexed64iv", ExactSpelling = true)]
        internal static extern void GetVertexArrayIndexed64iv(UInt32 vaobj, UInt32 index, VertexAttribParameter pname, [Out] Int64[] param);
        [DllImport(Library, EntryPoint = "glGetVertexArrayIndexediv", ExactSpelling = true)]
        internal static extern void GetVertexArrayIndexediv(UInt32 vaobj, UInt32 index, VertexAttribParameter pname, [Out] Int32[] param);
        ...
        internal static extern void GetVertexAttribdv(UInt32 index, VertexAttribParameter pname, [Out] Double[] @params);
        [DllImport(Library, EntryPoint = "glGetVertexAttribfv", ExactSpelling = true)]
        internal static extern void GetVertexAttribfv(UInt32 index, VertexAttribParameter pname, [Out] Single[] @params);
        ...
        internal static extern void GetVertexAttribIiv(UInt32 index, VertexAttribParameter pname, [Out] Int32[] @params);
        [DllImport(Library, EntryPoint = "glGetVertexAttribIuiv", ExactSpelling = true)]
        internal static extern void GetVertexAttribIuiv(UInt32 index, VertexAttribParameter pname, [Out] UInt32[] @params);
        [DllImport(Library, EntryPoint = "glGetVertexAttribLdv", ExactSpelling = true)]
        internal static extern void GetVertexAttribLdv(UInt32 index, VertexAttribParameter pname, [Out] Double[] @params);
        [DllImport(Library, EntryPoint = "glGetVertexAttribPointerv", ExactSpelling = true)]
        internal static extern void GetVertexAttribPointerv(UInt32 index, VertexAttribPointerParameter pname, [Out] IntPtr pointer);
        ...
        internal static extern void InvalidateFramebuffer(FramebufferTarget target, Int32 numAttachments, FramebufferAttachment[] attachments);
        [DllImport(Library, EntryPoint = "glInvalidateNamedFramebufferData", ExactSpelling = true)]
        internal static extern void InvalidateNamedFramebufferData(UInt32 framebuffer, Int32 numAttachments, FramebufferAttachment[] attachments);
        [DllImport(Library, EntryPoint = "glInvalidateSubFramebuffer", ExactSpelling = true)]
        internal static extern void InvalidateSubFramebuffer(FramebufferTarget target, Int32 numAttachments, FramebufferAttachment[] attachments, Int32 x, Int32 y, Int32 width, Int32 height);
        [DllImport(Library, EntryPoint = "glInvalidateNamedFramebufferSubData", ExactSpelling = true)]
        internal static extern void InvalidateNamedFramebufferSubData(UInt32 framebuffer, Int32 numAttachments, FramebufferAttachment[] attachments, Int32 x, Int32 y, Int32 width, Int32 height);
        ...
        internal static extern void MultiDrawArraysIndirect(BeginMode mode, IntPtr indirect, Int32 drawcount, Int32 stride);
        [DllImport(Library, EntryPoint = "glMultiDrawElements", ExactSpelling = true)]
        internal static extern void MultiDrawElements(BeginMode mode, Int32[] count, DrawElementsType type, IntPtr indices, Int32 drawcount);
        [DllImport(Library, EntryPoint = "glMultiDrawElementsBaseVertex", ExactSpelling = true)]
        internal static extern void MultiDrawElementsBaseVertex(BeginMode mode, Int32[] count, DrawElementsType type, IntPtr indices, Int32 drawcount, Int32[] basevertex);
        [DllImport(Library, EntryPoint = "glMultiDrawElementsIndirect", ExactSpelling = true)]
        internal static extern void MultiDrawElementsIndirect(BeginMode mode, DrawElementsType type, IntPtr indirect, Int32 drawcount, Int32 stride);
        ...
        internal static extern void ReadPixels(Int32 x, Int32 y, Int32 width, Int32 height, PixelFormat format, PixelType type, Int32[] data);
        [DllImport(Library, EntryPoint = "glReadnPixels", ExactSpelling = true)]
        internal static extern void ReadnPixels(Int32 x, Int32 y, Int32 width, Int32 height, PixelFormat format, PixelType type, Int32 bufSize, Int32[] data);
        [DllImport(Library, EntryPoint = "glRenderbufferStorage", ExactSpelling = true)]
        internal static extern void RenderbufferStorage(RenderbufferTarget target, RenderbufferStorage internalFormat, Int32 width, Int32 height);
        [DllImport(Library, EntryPoint = "glNamedRenderbufferStorage", ExactSpelling = true)]
        internal static extern void NamedRenderbufferStorage(UInt32 renderbuffer, RenderbufferStorage internalFormat, Int32 width, Int32 height);
        [DllImport(Library, EntryPoint = "glRenderbufferStorageMultisample", ExactSpelling = true)]
        internal static extern void RenderbufferStorageMultisample(RenderbufferTarget target, Int32 samples, RenderbufferStorage internalFormat, Int32 width, Int32 height);
        [DllImport(Library, EntryPoint = "glNamedRenderbufferStorageMultisample", ExactSpelling = true)]
        internal static extern void NamedRenderbufferStorageMultisample(UInt32 renderbuffer, Int32 samples, RenderbufferStorage internalFormat, Int32 width, Int32 height);
        ...
        internal static extern void StencilFuncSeparate(StencilFace face, StencilFunction func, Int32 @ref, UInt32 mask);
        ...
        internal static extern void TexBuffer(TextureBufferTarget target, SizedInternalFormat internalFormat, UInt32 buffer);
        ...
        internal static extern void TexBufferRange(BufferTarget target, SizedInternalFormat internalFormat, UInt32 buffer, IntPtr offset, IntPtr size);
        [DllImport(Library, EntryPoint = "glTextureBufferRange", ExactSpelling = true)]
        internal static extern void TextureBufferRange(UInt32 texture, SizedInternalFormat internalFormat, UInt32 buffer, IntPtr offset, Int32 size);
        [DllImport(Library, EntryPoint = "glTexImage1D", ExactSpelling = true)]
        internal static extern void TexImage1D(TextureTarget target, Int32 level, PixelInternalFormat internalFormat, Int32 width, Int32 border, PixelFormat format, PixelType type, IntPtr data);
        [DllImport(Library, EntryPoint = "glTexImage2D", ExactSpelling = true)]
        internal static extern void TexImage2D(TextureTarget target, Int32 level, PixelInternalFormat internalFormat, Int32 width, Int32 height, Int32 border, PixelFormat format, PixelType type, IntPtr data);
        [DllImport(Library, EntryPoint = "glTexImage2DMultisample", ExactSpelling = true)]
        internal static extern void TexImage2DMultisample(TextureTargetMultisample target, Int32 samples, PixelInternalFormat internalFormat, Int32 width, Int32 height, Boolean fixedsamplelocations);
        [DllImport(Library, EntryPoint = "glTexImage3D", ExactSpelling = true)]
        internal static extern void TexImage3D(TextureTarget target, Int32 level, PixelInternalFormat internalFormat, Int32 width, Int32 height, Int32 depth, Int32 border, PixelFormat format, PixelType type, IntPtr data);
        [DllImport(Library, EntryPoint = "glTexImage3DMultisample", ExactSpelling = true)]
        internal static extern void TexImage3DMultisample(TextureTargetMultisample target, Int32 samples, PixelInternalFormat internalFormat, Int32 width, Int32 height, Int32 depth, Boolean fixedsamplelocations);
        ...
        internal static extern void TexParameterIuiv(TextureTarget target, TextureParameterName pname, UInt32[] @params);
        ...
        internal static extern void TexStorage1D(TextureTarget target, Int32 levels, SizedInternalFormat internalFormat, Int32 width);
        [DllImport(Library, EntryPoint = "glTextureStorage1D", ExactSpelling = true)]
        internal static extern void TextureStorage1D(UInt32 texture, Int32 levels, SizedInternalFormat internalFormat, Int32 width);
        [DllImport(Library, EntryPoint = "glTexStorage2D", ExactSpelling = true)]
        internal static extern void TexStorage2D(TextureTarget target, Int32 levels, SizedInternalFormat internalFormat, Int32 width, Int32 height);
        [DllImport(Library, EntryPoint = "glTextureStorage2D", ExactSpelling = true)]
        internal static extern void TextureStorage2D(UInt32 texture, Int32 levels, SizedInternalFormat internalFormat, Int32 width, Int32 height);
        [DllImport(Library, EntryPoint = "glTexStorage2DMultisample", ExactSpelling = true)]
        internal static extern void TexStorage2DMultisample(TextureTarget target, Int32 samples, SizedInternalFormat internalFormat, Int32 width, Int32 height, Boolean fixedsamplelocations);
        [DllImport(Library, EntryPoint = "glTextureStorage2DMultisample", ExactSpelling = true)]
        internal static extern void TextureStorage2DMultisample(UInt32 texture, Int32 samples, SizedInternalFormat internalFormat, Int32 width, Int32 height, Boolean fixedsamplelocations);
        [DllImport(Library, EntryPoint = "glTexStorage3D", ExactSpelling = true)]
        internal static extern void TexStorage3D(TextureTarget target, Int32 levels, SizedInternalFormat internalFormat, Int32 width, Int32 height, Int32 depth);
        [DllImport(Library, EntryPoint = "glTextureStorage3D", ExactSpelling = true)]
        internal static extern void TextureStorage3D(UInt32 texture, Int32 levels, SizedInternalFormat internalFormat, Int32 width, Int32 height, Int32 depth);
        [DllImport(Library, EntryPoint = "glTexStorage3DMultisample", ExactSpelling = true)]
        internal static extern void TexStorage3DMultisample(TextureTarget target, Int32 samples, SizedInternalFormat internalFormat, Int32 width, Int32 height, Int32 depth, Boolean fixedsamplelocations);
        [DllImport(Library, EntryPoint = "glTextureStorage3DMultisample", ExactSpelling = true)]
        internal static extern void TextureStorage3DMultisample(UInt32 texture, Int32 samples, SizedInternalFormat internalFormat, Int32 width, Int32 height, Int32 depth, Boolean fixedsamplelocations);
        [DllImport(Library, EntryPoint = "glTexSubImage1D", ExactSpelling = true)]
        internal static extern void TexSubImage1D(TextureTarget target, Int32 level, Int32 xoffset, Int32 width, PixelFormat format, PixelType type, IntPtr pixels);
        [DllImport(Library, EntryPoint = "glTextureSubImage1D", ExactSpelling = true)]
        internal static extern void TextureSubImage1D(UInt32 texture, Int32 level, Int32 xoffset, Int32 width, PixelFormat format, PixelType type, IntPtr pixels);
        [DllImport(Library, EntryPoint = "glTexSubImage2D", ExactSpelling = true)]
        internal static extern void TexSubImage2D(TextureTarget target, Int32 level, Int32 xoffset, Int32 yoffset, Int32 width, Int32 height, PixelFormat format, PixelType type, IntPtr pixels);
        [DllImport(Library, EntryPoint = "glTextureSubImage2D", ExactSpelling = true)]
        internal static extern void TextureSubImage2D(UInt32 texture, Int32 level, Int32 xoffset, Int32 yoffset, Int32 width, Int32 height, PixelFormat format, PixelType type, IntPtr pixels);
        [DllImport(Library, EntryPoint = "glTexSubImage3D", ExactSpelling = true)]
        internal static extern void TexSubImage3D(TextureTarget target, Int32 level, Int32 xoffset, Int32 yoffset, Int32 zoffset, Int32 width, Int32 height, Int32 depth, PixelFormat format, PixelType type, IntPtr pixels);
        [DllImport(Library, EntryPoint = "glTextureSubImage3D", ExactSpelling = true)]
        internal static extern void TextureSubImage3D(UInt32 texture, Int32 level, Int32 xoffset, Int32 yoffset, Int32 zoffset, Int32 width, Int32 height, Int32 depth, PixelFormat format, PixelType type, IntPtr pixels);
        ...
        internal static extern void TextureView(UInt32 texture, TextureTarget target, UInt32 origtexture, PixelInternalFormat internalFormat, UInt32 minlevel, UInt32 numlevels, UInt32 minlayer, UInt32 numlayers);
        ...
        internal static extern void TransformFeedbackVaryings(UInt32 program, Int32 count, String[] varyings, TransformFeedbackMode bufferMode);
        ...
        internal static extern void VertexAttribP1ui(UInt32 index, VertexAttribPType type, Boolean normalized, UInt32 value);
        [DllImport(Library, EntryPoint = "glVertexAttribP2ui", ExactSpelling = true)]
        internal static extern void VertexAttribP2ui(UInt32 index, VertexAttribPType type, Boolean normalized, UInt32 value);
        [DllImport(Library, EntryPoint = "glVertexAttribP3ui", ExactSpelling = true)]
        internal static extern void VertexAttribP3ui(UInt32 index, VertexAttribPType type, Boolean normalized, UInt32 value);
        [DllImport(Library, EntryPoint = "glVertexAttribP4ui", ExactSpelling = true)]
        internal static extern void VertexAttribP4ui(UInt32 index, VertexAttribPType type, Boolean normalized, UInt32 value);
        ...
        internal static extern void VertexAttribFormat(UInt32 attribindex, Int32 size, VertexAttribFormat type, Boolean normalized, UInt32 relativeoffset);
        [DllImport(Library, EntryPoint = "glVertexAttribIFormat", ExactSpelling = true)]
        internal static extern void VertexAttribIFormat(UInt32 attribindex, Int32 size, VertexAttribFormat type, UInt32 relativeoffset);
        [DllImport(Library, EntryPoint = "glVertexAttribLFormat", ExactSpelling = true)]
        internal static extern void VertexAttribLFormat(UInt32 attribindex, Int32 size, VertexAttribFormat type, UInt32 relativeoffset);
        [DllImport(Library, EntryPoint = "glVertexArrayAttribFormat", ExactSpelling = true)]
        internal static extern void VertexArrayAttribFormat(UInt32 vaobj, UInt32 attribindex, Int32 size, VertexAttribFormat type, Boolean normalized, UInt32 relativeoffset);
        [DllImport(Library, EntryPoint = "glVertexArrayAttribIFormat", ExactSpelling = true)]
        internal static extern void VertexArrayAttribIFormat(UInt32 vaobj, UInt32 attribindex, Int32 size, VertexAttribFormat type, UInt32 relativeoffset);
        [DllImport(Library, EntryPoint = "glVertexArrayAttribLFormat", ExactSpelling = true)]
        internal static extern void VertexArrayAttribLFormat(UInt32 vaobj, UInt32 attribindex, Int32 size, VertexAttribFormat type, UInt32 relativeoffset);
        [DllImport(Library, EntryPoint = "glVertexAttribPointer", ExactSpelling = true)]
        internal static extern void VertexAttribPointer(UInt32 index, Int32 size, VertexAttribPointerType type, Boolean normalized, Int32 stride, IntPtr pointer);
        [DllImport(Library, EntryPoint = "glVertexAttribIPointer", ExactSpelling = true)]
        internal static extern void VertexAttribIPointer(UInt32 index, Int32 size, VertexAttribPointerType type, Int32 stride, IntPtr pointer);
        [DllImport(Library, EntryPoint = "glVertexAttribLPointer", ExactSpelling = true)]
        internal static extern void VertexAttribLPointer(UInt32 index, Int32 size, VertexAttribPointerType type, Int32 stride, IntPtr pointer);

...
using Engine.OpenGL.OpenGL.Core;
...
namespace OpenGL
{
    ...
    partial class Gl
    {
        internal static partial class Delegates
        {
            ...
            internal delegate void GetObjectLabel(Engine.OpenGL.OpenGL.Core.ObjectLabel identifier, UInt32 name, Int32 bufSize, [OutAttribute] Int32[] length, [OutAttribute] System.Text.StringBuilder label);
            ...
            internal delegate void LogicOp(Engine.OpenGL.OpenGL.Core.LogicOp opcode);
            ...
            internal delegate void ObjectLabel(Engine.OpenGL.OpenGL.Core.ObjectLabel identifier, UInt32 name, Int32 length, String label);
            ...
            internal delegate void PolygonMode(MaterialFace face, Engine.OpenGL.OpenGL.Core.PolygonMode mode);
            ...
            internal delegate void RenderbufferStorage(RenderbufferTarget target, Engine.OpenGL.OpenGL.Core.RenderbufferStorage internalFormat, Int32 width, Int32 height);
            internal static RenderbufferStorage glRenderbufferStorage;
            internal delegate void NamedRenderbufferStorage(UInt32 renderbuffer, Engine.OpenGL.OpenGL.Core.RenderbufferStorage internalFormat, Int32 width, Int32 height);
            internal static NamedRenderbufferStorage glNamedRenderbufferStorage;
            internal delegate void RenderbufferStorageMultisample(RenderbufferTarget target, Int32 samples, Engine.OpenGL.OpenGL.Core.RenderbufferStorage internalFormat, Int32 width, Int32 height);
            internal static RenderbufferStorageMultisample glRenderbufferStorageMultisample;
            internal delegate void NamedRenderbufferStorageMultisample(UInt32 renderbuffer, Int32 samples, Engine.OpenGL.OpenGL.Core.RenderbufferStorage internalFormat, Int32 width, Int32 height);
            ...
            internal delegate void StencilOp(Engine.OpenGL.OpenGL.Core.StencilOp sfail, Engine.OpenGL.OpenGL.Core.StencilOp dpfail, Engine.OpenGL.OpenGL.Core.StencilOp dppass);
            internal static StencilOp glStencilOp;
            internal delegate void StencilOpSeparate(StencilFace face, Engine.OpenGL.OpenGL.Core.StencilOp sfail, Engine.OpenGL.OpenGL.Core.StencilOp dpfail, Engine.OpenGL.OpenGL.Core.StencilOp dppass);
            ...
            internal delegate void VertexAttribFormat(UInt32 attribindex, Int32 size, Engine.OpenGL.OpenGL.Core.VertexAttribFormat type, Boolean normalized, UInt32 relativeoffset);
            internal static VertexAttribFormat glVertexAttribFormat;
            internal delegate void VertexAttribIFormat(UInt32 attribindex, Int32 size, Engine.OpenGL.OpenGL.Core.VertexAttribFormat type, UInt32 relativeoffset);
            internal static VertexAttribIFormat glVertexAttribIFormat;
            internal delegate void VertexAttribLFormat(UInt32 attribindex, Int32 size, Engine.OpenGL.OpenGL.Core.VertexAttribFormat type, UInt32 relativeoffset);
            internal static VertexAttribLFormat glVertexAttribLFormat;
            internal delegate void VertexArrayAttribFormat(UInt32 vaobj, UInt32 attribindex, Int32 size, Engine.OpenGL.OpenGL.Core.VertexAttribFormat type, Boolean normalized, UInt32 relativeoffset);
            internal static VertexArrayAttribFormat glVertexArrayAttribFormat;
            internal delegate void VertexArrayAttribIFormat(UInt32 vaobj, UInt32 attribindex, Int32 size, Engine.OpenGL.OpenGL.Core.VertexAttribFormat type, UInt32 relativeoffset);
            internal static VertexArrayAttribIFormat glVertexArrayAttribIFormat;
            internal delegate void VertexArrayAttribLFormat(UInt32 vaobj, UInt32 attribindex, Int32 size, Engine.OpenGL.OpenGL.Core.VertexAttribFormat type, UInt32 relativeoffset);

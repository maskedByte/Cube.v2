...
public struct Matrix3 : IEquatable<Matrix3>
{
    ...
    public static void CreateFromQuaternion(in Quaternion.Quaternion q, out Matrix3 result)
    {
    ...
    /// <returns>A matrix instance.</returns>
    [Pure]
    public static Matrix3 CreateFromQuaternion(Quaternion.Quaternion q)
    {

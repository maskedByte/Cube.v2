...
internal partial class Gl
{
    ...
    public static void ReloadExtensions()
    {
        ...
        if (Version() >= 3)
        {
            ...
            for (var i = 0; i < extensionCount; i++)
            {
                ...
                if (!stringExtensions.Contains(extension))
                {
                    stringExtensions.Add(extension.ToLower());
                }
            }
        }
        else
        {
            ...
            for (var i = 0; i < extensions.Length; i++)
            {
                ...
                else if (!stringExtensions.Contains(extensions[i]))
                {
                    stringExtensions.Add(extensions[i].ToLower());
                }
            }
        }
    ...
    public static string[] GetExtensions() => Enum.GetNames(typeof(Extension));
    ...
    public static class Extensions
    {
        ...
        public static bool LXARBVertexBufferObject_GLX => IsExtensionSupported(Extension.GLX_ARB_vertex_buffer_object);
        ...
        public static bool TextureCompressionRgtc => IsExtensionSupported(Extension.GL_ARB_texture_compression_rgtc);
        ...
        public static bool DrawElementsBaseVertex => IsExtensionSupported(Extension.GL_ARB_draw_elements_base_vertex);

        public static bool FragmentCoordConventions => IsExtensionSupported(Extension.GL_ARB_fragment_coord_conventions);
        ...
        public static bool ARBCreateContextProfile_WGL => IsExtensionSupported(Extension.WGL_ARB_create_context_profile);

        public static bool LXARBCreateContextProfile_GLX => IsExtensionSupported(Extension.GLX_ARB_create_context_profile);

        public static bool ShadingLanguageInclude => IsExtensionSupported(Extension.GL_ARB_shading_language_include);

        public static bool TextureCompressionBptc => IsExtensionSupported(Extension.GL_ARB_texture_compression_bptc);

        public static bool BlendFuncExtended => IsExtensionSupported(Extension.GL_ARB_blend_func_extended);

        public static bool ExplicitAttribLocation => IsExtensionSupported(Extension.GL_ARB_explicit_attrib_location);
        ...
        public static bool VertexType2101010Rev => IsExtensionSupported(Extension.GL_ARB_vertex_type_2_10_10_10_rev);
        ...
        public static bool TextureBufferObjectRgb32 => IsExtensionSupported(Extension.GL_ARB_texture_buffer_object_rgb32);
        ...
        public static bool LXARBCreateContextRobustness_GLX => IsExtensionSupported(Extension.GLX_ARB_create_context_robustness);

        public static bool ARBCreateContextRobustness_WGL => IsExtensionSupported(Extension.WGL_ARB_create_context_robustness);
        ...
        public static bool ShadingLanguage420pack => IsExtensionSupported(Extension.GL_ARB_shading_language_420pack);

        public static bool TransformFeedbackInstanced => IsExtensionSupported(Extension.GL_ARB_transform_feedback_instanced);

        public static bool CompressedTexturePixelStorage => IsExtensionSupported(Extension.GL_ARB_compressed_texture_pixel_storage);
        ...
        public static bool ShadingLanguagePacking => IsExtensionSupported(Extension.GL_ARB_shading_language_packing);

        public static bool TextureStorage => IsExtensionSupported(Extension.GL_ARB_texture_storage);

        public static bool TextureCompressionAstcHdr_KHR => IsExtensionSupported(Extension.GL_KHR_texture_compression_astc_hdr);

        public static bool TextureCompressionAstcLdr_KHR => IsExtensionSupported(Extension.GL_KHR_texture_compression_astc_ldr);
        ...
        public static bool ExplicitUniformLocation => IsExtensionSupported(Extension.GL_ARB_explicit_uniform_location);

        public static bool FragmentLayerViewport => IsExtensionSupported(Extension.GL_ARB_fragment_layer_viewport);

        public static bool FramebufferNoAttachments => IsExtensionSupported(Extension.GL_ARB_framebuffer_no_attachments);
        ...
        public static bool RobustBufferAccessBehavior => IsExtensionSupported(Extension.GL_ARB_robust_buffer_access_behavior);

        public static bool ShaderImageSize => IsExtensionSupported(Extension.GL_ARB_shader_image_size);

        public static bool ShaderStorageBufferObject => IsExtensionSupported(Extension.GL_ARB_shader_storage_buffer_object);
        ...
        public static bool TextureStorageMultisample => IsExtensionSupported(Extension.GL_ARB_texture_storage_multisample);
        ...
        public static bool ARBRobustnessShareGroupIsolation_WGL => IsExtensionSupported(Extension.WGL_ARB_robustness_share_group_isolation);
        ...
        public static bool TextureMirrorClampToEdge => IsExtensionSupported(Extension.GL_ARB_texture_mirror_clamp_to_edge);

        public static bool TextureStencil8 => IsExtensionSupported(Extension.GL_ARB_texture_stencil8);

        public static bool VertexType10f11f11fRev => IsExtensionSupported(Extension.GL_ARB_vertex_type_10f_11f_11f_rev);

        public static bool BindlessTexture => IsExtensionSupported(Extension.GL_ARB_bindless_texture);

        public static bool ComputeVariableGroupSize => IsExtensionSupported(Extension.GL_ARB_compute_variable_group_size);

        public static bool IndirectParameters => IsExtensionSupported(Extension.GL_ARB_indirect_parameters);

        public static bool SeamlessCubemapPerTexture => IsExtensionSupported(Extension.GL_ARB_seamless_cubemap_per_texture);
        ...
        public static bool ConditionalRenderInverted => IsExtensionSupported(Extension.GL_ARB_conditional_render_inverted);
        ...
        public static bool ShaderTextureImageSamples => IsExtensionSupported(Extension.GL_ARB_shader_texture_image_samples);
        ...
        public static bool LXARBContextFlushControl_GLX => IsExtensionSupported(Extension.GLX_ARB_context_flush_control);

        public static bool ARBContextFlushControl_WGL => IsExtensionSupported(Extension.WGL_ARB_context_flush_control);

        public static bool RobustBufferAccessBehavior_KHR => IsExtensionSupported(Extension.GL_KHR_robust_buffer_access_behavior);

        public static bool Robustness_KHR => IsExtensionSupported(Extension.GL_KHR_robustness);

        public static bool PipelineStatisticsQuery => IsExtensionSupported(Extension.GL_ARB_pipeline_statistics_query);

        public static bool SparseBuffer => IsExtensionSupported(Extension.GL_ARB_sparse_buffer);

        public static bool TransformFeedbackOverflowQuery => IsExtensionSupported(Extension.GL_ARB_transform_feedback_overflow_query);

        public static bool BlendEquationAdvanced_KHR => IsExtensionSupported(Extension.GL_KHR_blend_equation_advanced);

        public static bool BlendEquationAdvancedCoherent_KHR => IsExtensionSupported(Extension.GL_KHR_blend_equation_advanced_coherent);
        ...
        public static bool FragmentShaderInterlock => IsExtensionSupported(Extension.GL_ARB_fragment_shader_interlock);
        ...
        public static bool ShaderAtomicCounterOps => IsExtensionSupported(Extension.GL_ARB_shader_atomic_counter_ops);
        ...
        public static bool ShaderViewportLayerArray => IsExtensionSupported(Extension.GL_ARB_shader_viewport_layer_array);
        ...
        public static bool TextureCompressionAstcSliced3d_KHR => IsExtensionSupported(Extension.GL_KHR_texture_compression_astc_sliced_3d);
        ...
        public static bool ConvolutionBorderModes_HP => IsExtensionSupported(Extension.GL_HP_convolution_border_modes);
        ...
        public static bool PixelTransformColorTable_EXT => IsExtensionSupported(Extension.GL_EXT_pixel_transform_color_table);

        public static bool SharedTexturePalette_EXT => IsExtensionSupported(Extension.GL_EXT_shared_texture_palette);

        public static bool LXSGISBlendedOverlay_GLX => IsExtensionSupported(Extension.GLX_SGIS_blended_overlay);

        public static bool SeparateSpecularColor_EXT => IsExtensionSupported(Extension.GL_EXT_separate_specular_color);
        ...
        public static bool TexturePerturbNormal_EXT => IsExtensionSupported(Extension.GL_EXT_texture_perturb_normal);
        ...
        public static bool ConvolutionBorderModes_SUN => IsExtensionSupported(Extension.GL_SUN_convolution_border_modes);

        public static bool LXSUNGetTransparentIndex_GLX => IsExtensionSupported(Extension.GLX_SUN_get_transparent_index);
        ...
        public static bool TextureFilterAnisotropic_EXT => IsExtensionSupported(Extension.GL_EXT_texture_filter_anisotropic);
        ...
        public static bool TextureCompressionS3tc_EXT => IsExtensionSupported(Extension.GL_EXT_texture_compression_s3tc);
        ...
        public static bool TextureCompressionFXT1_3DFX => IsExtensionSupported(Extension.GL_3DFX_texture_compression_FXT1);
        ...
        public static bool TextureMirroredRepeat_IBM => IsExtensionSupported(Extension.GL_IBM_texture_mirrored_repeat);
        ...
        public static bool TextureCompressionVtc_NV => IsExtensionSupported(Extension.GL_NV_texture_compression_vtc);
        ...
        public static bool LXSGIXVisualSelectGroup_GLX => IsExtensionSupported(Extension.GLX_SGIX_visual_select_group);

        public static bool TextureCoordinateClamp_SGIX => IsExtensionSupported(Extension.GL_SGIX_texture_coordinate_clamp);
        ...
        public static bool I3DDigitalVideoControl_WGL => IsExtensionSupported(Extension.WGL_I3D_digital_video_control);
        ...
        public static bool MultisampleFilterHint_NV => IsExtensionSupported(Extension.GL_NV_multisample_filter_hint);
        ...
        public static bool NVRenderTextureRectangle_WGL => IsExtensionSupported(Extension.WGL_NV_render_texture_rectangle);
        ...
        public static bool VertexAttribArrayObject_ATI => IsExtensionSupported(Extension.GL_ATI_vertex_attrib_array_object);
        ...
        public static bool CompressedPalettedTexture_OES => IsExtensionSupported(Extension.GL_OES_compressed_paletted_texture);
        ...
        public static bool BlendEquationSeparate_EXT => IsExtensionSupported(Extension.GL_EXT_blend_equation_separate);
        ...
        public static bool FragmentProgramOption_NV => IsExtensionSupported(Extension.GL_NV_fragment_program_option);
        ...
        public static bool TextureCompressionDxt1_EXT => IsExtensionSupported(Extension.GL_EXT_texture_compression_dxt1);
        ...
        public static bool FramebufferMultisample_EXT => IsExtensionSupported(Extension.GL_EXT_framebuffer_multisample);
        ...
        public static bool GpuProgramParameters_EXT => IsExtensionSupported(Extension.GL_EXT_gpu_program_parameters);
        ...
        public static bool EXTPixelFormatPackedFloat_WGL => IsExtensionSupported(Extension.WGL_EXT_pixel_format_packed_float);

        public static bool LXEXTFbconfigPackedFloat_GLX => IsExtensionSupported(Extension.GLX_EXT_fbconfig_packed_float);
        ...
        public static bool TextureCompressionLatc_EXT => IsExtensionSupported(Extension.GL_EXT_texture_compression_latc);

        public static bool TextureCompressionRgtc_EXT => IsExtensionSupported(Extension.GL_EXT_texture_compression_rgtc);

        public static bool TextureSharedExponent_EXT => IsExtensionSupported(Extension.GL_EXT_texture_shared_exponent);
        ...
        public static bool FramebufferMultisampleCoverage_NV => IsExtensionSupported(Extension.GL_NV_framebuffer_multisample_coverage);
        ...
        public static bool ParameterBufferObject_NV => IsExtensionSupported(Extension.GL_NV_parameter_buffer_object);
        ...
        public static bool LXEXTTextureFromPixmap_GLX => IsExtensionSupported(Extension.GLX_EXT_texture_from_pixmap);
        ...
        public static bool VertexShaderTessellator_AMD => IsExtensionSupported(Extension.GL_AMD_vertex_shader_tessellator);
        ...
        public static bool VertexProgramEvaluators_APPLE => IsExtensionSupported(Extension.GL_APPLE_vertex_program_evaluators);
        ...
        public static bool SeparateShaderObjects_EXT => IsExtensionSupported(Extension.GL_EXT_separate_shader_objects);

        public static bool ParameterBufferObject2_NV => IsExtensionSupported(Extension.GL_NV_parameter_buffer_object2);

        public static bool ShaderBufferLoad_NV => IsExtensionSupported(Extension.GL_NV_shader_buffer_load);

        public static bool VertexBufferUnifiedMemory_NV => IsExtensionSupported(Extension.GL_NV_vertex_buffer_unified_memory);
        ...
        public static bool SeamlessCubemapPerTexture_AMD => IsExtensionSupported(Extension.GL_AMD_seamless_cubemap_per_texture);
        ...
        public static bool ShaderImageLoadStore_EXT => IsExtensionSupported(Extension.GL_EXT_shader_image_load_store);
        ...
        public static bool VertexAttribInteger64bit_NV => IsExtensionSupported(Extension.GL_NV_vertex_attrib_integer_64bit);
        ...
        public static bool LXEXTCreateContextEs2Profile_GLX => IsExtensionSupported(Extension.GLX_EXT_create_context_es2_profile);

        public static bool LXEXTCreateContextEsProfile_GLX => IsExtensionSupported(Extension.GLX_EXT_create_context_es_profile);

        public static bool EXTCreateContextEs2Profile_WGL => IsExtensionSupported(Extension.WGL_EXT_create_context_es2_profile);

        public static bool EXTCreateContextEsProfile_WGL => IsExtensionSupported(Extension.WGL_EXT_create_context_es_profile);
        ...
        public static bool StencilOperationExtended_AMD => IsExtensionSupported(Extension.GL_AMD_stencil_operation_extended);
        ...
        public static bool VertexShaderViewportIndex_AMD => IsExtensionSupported(Extension.GL_AMD_vertex_shader_viewport_index);
        ...
        public static bool ShaderStorageBufferObject_NV => IsExtensionSupported(Extension.GL_NV_shader_storage_buffer_object);
        ...
        public static bool BindlessMultiDrawIndirect_NV => IsExtensionSupported(Extension.GL_NV_bindless_multi_draw_indirect);

        public static bool BlendEquationAdvanced_NV => IsExtensionSupported(Extension.GL_NV_blend_equation_advanced);

        public static bool BlendEquationAdvancedCoherent_NV => IsExtensionSupported(Extension.GL_NV_blend_equation_advanced_coherent);

        public static bool GpuProgram5MemExtended_NV => IsExtensionSupported(Extension.GL_NV_gpu_program5_mem_extended);

        public static bool ShaderAtomicCounterOps_AMD => IsExtensionSupported(Extension.GL_AMD_shader_atomic_counter_ops);
        ...
        public static bool FragmentShaderOrdering_INTEL => IsExtensionSupported(Extension.GL_INTEL_fragment_shader_ordering);
        ...
        public static bool ShaderStencilValueExport_AMD => IsExtensionSupported(Extension.GL_AMD_shader_stencil_value_export);
        ...
        public static bool ShaderImageLoadFormatted_EXT => IsExtensionSupported(Extension.GL_EXT_shader_image_load_formatted);
        ...
        public static bool BindlessMultiDrawIndirectCount_NV => IsExtensionSupported(Extension.GL_NV_bindless_multi_draw_indirect_count);

        public static bool LXNVCopyBuffer_GLX => IsExtensionSupported(Extension.GLX_NV_copy_buffer);

        public static bool UniformBufferUnifiedMemory_NV => IsExtensionSupported(Extension.GL_NV_uniform_buffer_unified_memory);
        ...
        public static bool FragmentCoverageToColor_NV => IsExtensionSupported(Extension.GL_NV_fragment_coverage_to_color);

        public static bool FragmentShaderInterlock_NV => IsExtensionSupported(Extension.GL_NV_fragment_shader_interlock);

        public static bool FramebufferMixedSamples_NV => IsExtensionSupported(Extension.GL_NV_framebuffer_mixed_samples);

        public static bool GeometryShaderPassthrough_NV => IsExtensionSupported(Extension.GL_NV_geometry_shader_passthrough);

        public static bool PathRenderingSharedEdge_NV => IsExtensionSupported(Extension.GL_NV_path_rendering_shared_edge);

        public static bool SampleLocations_NV => IsExtensionSupported(Extension.GL_NV_sample_locations);

        public static bool SampleMaskOverrideCoverage_NV => IsExtensionSupported(Extension.GL_NV_sample_mask_override_coverage);

        public static bool ShaderAtomicFp16Vector_NV => IsExtensionSupported(Extension.GL_NV_shader_atomic_fp16_vector);

        public static bool InternalformatSampleQuery_NV => IsExtensionSupported(Extension.GL_NV_internalformat_sample_query);
        ...
        public static bool ConservativeRasterDilate_NV => IsExtensionSupported(Extension.GL_NV_conservative_raster_dilate);
        ...
        public static bool RobustnessVideoMemoryPurge_NV => IsExtensionSupported(Extension.GL_NV_robustness_video_memory_purge);

        public static bool ShaderExplicitVertexParameter_AMD => IsExtensionSupported(Extension.GL_AMD_shader_explicit_vertex_parameter);
        ...
        public static bool ConservativeRasterization_INTEL => IsExtensionSupported(Extension.GL_INTEL_conservative_rasterization);
        ...
        public static bool ShaderIntegerFunctions_MESA => IsExtensionSupported(Extension.GL_MESA_shader_integer_functions);

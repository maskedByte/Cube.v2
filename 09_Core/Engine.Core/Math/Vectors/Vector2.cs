...
public struct Vector2 : IEquatable<Vector2>
{
    ...
    public static void Dot(in Vector2 left, in Vector2 right, out float result) => result = left.X * right.X + left.Y * right.Y;
    ...
    public static void PerpDot(in Vector2 left, in Vector2 right, out float result) => result = left.X * right.Y - left.Y * right.X;

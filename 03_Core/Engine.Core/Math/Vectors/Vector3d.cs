...
public struct Vector3d : IEquatable<Vector3d>
{
    ...
    /// <see cref="Length" />
    /// <seealso cref="LengthSquared" />
    public double LengthFast => 1.0 / Mathf.InverseSqrtFast(X * X + Y * Y + Z * Z);
    ...
    public static void CalculateAngle(in Vector3d first, in Vector3d second, out double result)
    {
        ...
        result = System.Math.Acos(Mathf.Clamp(temp / (first.Length * second.Length), -1.0, 1.0));
    }
    ...
    /// <inheritdoc />
    public override bool Equals(object? obj) => obj is Vector3d vector3d && Equals(vector3d);

...
public struct AAB3 : IEquatable<AAB3>
{
    ...
    public AAB3(float minX, float minY, float minZ, float maxX, float maxY, float maxZ)
    ...
    {
        return _min.X < point.X && point.X < _max.X && _min.Y < point.Y && point.Y < _max.Y && _min.Z < point.Z &&
               point.Z < _max.Z;
    }
    ...
    public static bool operator ==(AAB3 left, AAB3 right)
    {
